...
userSyncPixels.create=function(a,b,c,d){if(!userSyncPixels._cookiesMap["usp."+a]){if(b===""||b.indexOf("$")===0)b=[];else b=b.split("|");b=b.find(function(a){return document.location.hostname.indexOf(a)!==-1});if(!!b===c)d()}purchs2sutils.cookies.set("usp."+a,1,"604800");userSyncPixels._cookiesMap["usp."+a]=1};var tmntag=tmntag||{};tmntag.pvLoggingDisabled=true;tmntag.pageHistory={};tmntag.pageHistory[window.location.pathname]=1;
tmntag_onPageChangedPrivate=function(a,b){if(!tmntag.pageHistory[b]){tmntag.pageHistory[b]=1;tmntag_onNewPage(b)}};(function(a){var b=a.replaceState;a.replaceState=function(c,e,f){if(typeof a.onreplacestate=="function"&&window.location.pathname!=f)a.onreplacestate(c,e,f);return b.apply(a,arguments)};var c=a.pushState;a.pushState=function(b,e,f){if(typeof a.onpushstate=="function"&&window.location.pathname!=f)a.onpushstate(b,e,f);return c.apply(a,arguments)}})(window.history);
history.onreplacestate=history.onpushstate=function(a,b,c){if(!tmntag.onPageChangedDisabled)tmntag_onPageChangedPrivate(b,c)};tmntag_onNewPage=function(a){if(!tmntag.pvLoggingDisabled)tmntag_triggerEvent("PV",{ep:encodeURIComponent(a)})};try {
...
userSyncPixels.create(22,"buyerzone.com|businessnewsdaily.com|space.com",false,function(){var a="${PAGE_DOMAIN:OPENX_1X1_ID}";if(a===""||a.indexOf("$")===0)a="538535676";var b=document.createElement("span"),c=Math.floor(Math.random()*11E3);b.style.display="none";var d=document.location.protocol;b.innerHTML='<iframe id="4451dc03ec" name="4451dc03ec" src="'+d+"//tmn-d.openx.net/w/1.0/afr?auid="+a+"&cb="+c+'" frameBorder="0" frameSpacing="0" scrolling="no" width="1" height="1"></iframe>';userSyncPixels._fragment.appendChild(b)});
...
userSyncPixels.create("22_OPEN-RTB","space.com",true,function(){var a=document.createElement("span"),b=Math.floor(Math.random()*11E3);a.style.display="none";var c=document.location.protocol==="https:"?"https":"http";a.innerHTML='<iframe style="display:none" src="//us-u.openx.net/w/1.0/cm?id=de2d90e5-4d26-4c8c-a342-3edcde51fdb1&ph=25af9286-f23b-4b02-abcd-f2ee3b564dab&r='+c+"%3A%2F%2Fads.servebom.com%2Fpartner%3Fcd%3D"+b+'%26svc%3Dus%26id%3D22%26uid%3D"></iframe>';
userSyncPixels._fragment.appendChild(a)});
...
if(window.tmntag&&tmntag.isMobile&&!tmntag.isMobile())userSyncPixels.create(42,"space.com|tomsguide.com|tomshardware.com|newsarama.com|livescience.com|laptopmag.com",true,function(){var a=document.createElement("script");a.type="text/javascript";a.async=true;a.src="//sync.bfmio.com/syncb?pid=132";userSyncPixels._fragment.appendChild(a)});
...
var partnerId=27;userSyncPixels.create(partnerId,"",false,function(){var a=document.createElement("script");a.type="text/javascript";a.async=true;a.src="https://px.powerlinks.com/user/identify?rurl=https%3A%2F%2Fads.servebom.com%2Fpartner%3Fsvc%3Dus%26id%3D"+partnerId+"%26uid%3D${USER}";userSyncPixels._fragment.appendChild(a)});
...
(function(){if(window.gdprUser)return;document.body.appendChild(userSyncPixels._fragment)})();
